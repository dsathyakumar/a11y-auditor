...
module.exports = function validator(selector, ignoreSpecific, executeGlobalRules) {
    ...
    if(_.isObject(selector)){
      ...
      if(appUtils.isNode(selector) && appUtils.isElement(selector)){
        return _conductAudit($(selector), ignoreSpecific, executeGlobalRules);
      }else{
...
var _conductAudit = function _conductAudit(selector, ignoreSpecific, executeGlobalRules){
  ...
  //execute global Rules only when the executeGlobalRules is TRUE & Not Undefined
  if (!_.isUndefined(executeGlobalRules) && _.isBoolean(executeGlobalRules)) {
