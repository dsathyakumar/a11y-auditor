...
//> This function provides an interface to add the rule ID that is corresponding to a TAG
function _addRuleToTag(_tag, _ruleID) {
    var _rulesArr;
    ...
    _rulesArr.push(_ruleID); //push the rule into the array of rules
}
