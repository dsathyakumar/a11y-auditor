...
var $ = require('jquery'),
    ...
    enums = rootRequire('lib/enums/enums'),
    axsUtils = rootRequire('lib/axs/axsUtils'),
    rulesExecutor = rootRequire("lib/rulesProcessor/rulesExecutor"),
    auditRulesCreator = rootRequire('lib/rulesProcessor/auditRulesCreator'),
    ruleTagNameMapper = rootRequire('lib/mapper/ruleTagNameMapper'),
    ruleHandlerMapper = rootRequire('lib/mapper/ruleHandlerMapper'),
    injector = rootRequire('lib/utils/injectDeps');
