...
function auditRunnerChoosy() {
    console.log('Its almost on the way... ');
}

//> function which takes in a selector rulesConfig and auditConfig object
//> 'selector' can be a valid HTML Selector (or) a valid DOM [object]
...
//> global rules are ignored by default
//> if no compliance is passed, all valid rules are run for the element
function auditRunnerAll(selector, rulesConfig, auditConfig) {
